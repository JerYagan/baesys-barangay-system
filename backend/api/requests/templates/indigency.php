...
<body>
    <div class="border-container">
        ...
        <div class="content" style="margin-top: -20px;">
            This is to certify further that the family of the above-named resident belongs to the 
            <span class="highlight">low-income bracket / indigent sector</span> of this community, with no stable 
            source of income, and is hereby classified as indigent.
        </div>

        <div class="content" style="margin-top: -20px;">
            This certification is being issued upon the request of the interested party for 
            <span class="highlight">"<?php echo htmlspecialchars($purpose); ?>"</span> (medical, financial, or educational assistance).
        </div>
        ...
        <div class="meta-info">
            <table style="width: 100%; border: none;">
                <tr>
                    <td style="width: 50%;">
                        <strong>O.R. Number:</strong> Exempted (RA 11261 / Indigent)<br>
                        <strong>Amount Paid:</strong> PHP <?php echo htmlspecialchars($fee); ?> (FREE)<br>
