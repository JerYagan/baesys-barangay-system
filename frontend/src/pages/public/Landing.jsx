...
const contactItems = [
  { label: 'Address', value: 'Barangay Baesa Hall, Quezon City, Metro Manila', icon: 'M17.657 16.657L13.414 20.9a2 2 0 01-2.828 0l-4.243-4.243a8 8 0 1111.314 0zM15 11a3 3 0 11-6 0 3 3 0 016 0z' },
  { label: 'Phone', value: '(02) 8123-4567', icon: 'M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z' },
  { label: 'Email', value: 'barangaybaesa@quezoncity.gov.ph', icon: 'M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z' },
]
...
export default function Landing() {
  ...
  useEffect(() => {
    const fetchLatest = async () => {
      try {
        const res = await api.get('/announcements/list.php?limit=3')
        if (res.data.success) {
